...
def main():
    ...
    # Generate synthetic data for first iteration
    print("Generating synthetic data for iteration 0...")
    synthetic_data_path = run_synthetic_generation(prompt_path, 0)

    # Evaluate synthetic data
    print("Evaluating synthetic data...")
    metrics = evaluate_synthetic_data(real_data, synthetic_data_path, prompt_name, 0)
    ...
    print(f"\nFirst iteration complete. Updated prompt saved to: {updated_prompt}")
    print("You can now run the second iteration with the updated prompt.")
